    ...
    async def loop(self) -> None:
        ...
        while True:
            try:
                ...
                res = await loop.run_in_executor(None, partial(requests.post, url=Config.get()["proxyEventRoute"], json=json.loads(json.dumps(ServerManager.status_dict(), default=str)), auth=("automsvc", "speed0Meter!")))
